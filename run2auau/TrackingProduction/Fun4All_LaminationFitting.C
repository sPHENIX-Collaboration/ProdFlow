    ...
    const std::string filelist = "filelist.list")
{
  ...
  G4TPC::LaminationOutputName = Form("Laminations_run2auau_%s-%08d.root",dbtag.c_str(),runnumber);
  G4TPC::LaminationFitName = Form("LaminationFits_run2auau_%s-%08d.pdf",dbtag.c_str(),runnumber);
